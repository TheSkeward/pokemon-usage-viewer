// Reborn has the full set of type Gems — one-use items that boost the power of
// a move of their type. They don't exist in USUM, so there's no Gen 7 Smogon
// usage for them. We proxy each gem's competitive demand with the matching
// Gen 7 Z-Crystal, which is also a one-use, type-keyed damage boost: if a
// Pokémon runs Buginium Z, it's a good bet it would want a Bug Gem in Reborn.
