...
function getRebornMachineAvailability() {
  return {
    ...
    // Badge timing from BIGJRA's walkthrough (episode → badge count held).
    tm49: { available: 'After Badge 04', location: 'Blacksteam Factory' },
    tm09: { available: 'After Badge 04', location: 'Azurine Island lab' },
    tm66: { available: 'After Badge 04', location: 'Azurine Island lab' },
    tm83: { available: 'After Badge 04', location: 'Azurine Island' },
    tm34: { available: 'After Badge 05', location: "Onyx Gym (Aya's TM)" },
    tmx4: { available: 'After Badge 05', location: 'From Cal, Pyrous Mountain' },
    tm94: { available: 'After Badge 05', location: 'Citrine Mountain' },
    tm37: { available: 'After Badge 05', location: 'Pyrous Mountain' },
    tm12: { available: 'After Badge 05', location: 'Tourmaline wasteland tunnels' },
    tm44: { available: 'After Badge 05', location: 'Underground Railnet East' },
    tm32: { available: 'After Badge 05', location: 'Chrysolia railcave' },
    tm85: { available: 'After Badge 05', location: 'Spinel Gym upstairs' },
    tm70: { available: 'After Badge 06', location: "Spinel Gym (Serra's TM)" },
    tm10: { available: 'After Badge 07', location: "Belrose Manse (Noel's TM)" },
